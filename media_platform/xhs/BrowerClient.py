...
class XiaoHongShuClient(AbstractApiClient):
    ...
    async def Browerget(self, uri: str, params=None) -> Dict:
        ...
        response_data = await self.playwright_page.evaluate(
                    """ ([fetchRequest,url]) => {
                        return (async () => {
        ...
        if response_data is None:
            raise DataFetchError(response_data)
        else:
    ...
    async def get_note_by_keyword(
        ...
        return await self.Browerpost(uri,data)
    ...
    async def get_note_by_id(self, note_id: str) -> Dict:
        ...
        res = await self.Browerpost(uri,data)
    ...
    async def get_notes_by_creator(
        ...
        return await self.Browerget(uri, data)
